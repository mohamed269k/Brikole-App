...
export const PlugZap: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M13 2l-2 2.5h3L12 7"/><path d="M10 14v-4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2Z"/><path d="M3.5 15H2v-2.5"/><path d="M18 14h2a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-2v8Z"/><path d="M20.5 15H22v-2.5"/><path d="M12.5 15H14v-2.5"/></svg>
);

export const PaintRoller: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="16" height="6" x="2" y="2" rx="2"/><path d="M10 8v12"/><path d="M18 14V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12h16Z"/></svg>
);

export const Droplets: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.44-2.25-1.2-3.02C9.04 8.5 8 7.3 8 6c0-1.1.9-2 2-2s2 .9 2 2c0 1.3-1.04 2.5-1.8 3.23-.76.77-1.2 1.86-1.2 3.02 0 2.23 1.8 4.05 4 4.05s4-1.82 4-4.05c0-1.16-.44-2.25-1.2-3.02C14.04 8.5 13 7.3 13 6c0-1.1.9-2 2-2s2 .9 2 2"/></svg>
);

export const Hammer: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m15 12-8.373 8.373a1 1 0 1 1-1.414-1.414L12.586 12l-1.414-1.414a1 1 0 0 1 0-1.414l2.828-2.828a1 1 0 0 1 1.414 0l4.242 4.242a1 1 0 0 1 0 1.414Z"/></svg>
);

export const Sofa: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 9V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2"/><path d="M3 11v5a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5a2 2 0 0 0-4-1H7a2 2 0 0 0-4 1Z"/><path d="M12 11v2"/><path d="M4 18v2"/><path d="M20 18v2"/></svg>
);
...
export const ArchiveBox: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
